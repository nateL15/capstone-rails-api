...
RSpec.describe ChampionsController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new champion" do

        post :create, params: {champion: valid_attributes}, session: valid_session
        expect(response).to have_http_status(:created)
        expect(response.content_type).to eq('application/json')
        expect(response.location).to eq(champion_url(Champion.last))
      end
    end

    context "with invalid params" do
      it "renders a JSON response with errors for the new champion" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "renders a JSON response with the champion" do
        champion = Champion.create! valid_attributes
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the champion" do
        champion = Champion.create! valid_attributes
